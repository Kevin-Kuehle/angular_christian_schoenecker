...
class AngularFireAuth {
    ...
    constructor(options, nameOrConfig, platformId, zone) {
         ...
         * @return {?}
         */
        () => __webpack_require__.e(/*! import() | firebase-auth */ "firebase-auth").then(__webpack_require__.bind(null, /*! firebase/auth */ "./node_modules/firebase/auth/dist/index.esm.js")))))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((/**
         * @return {?}
         */
...
class AuthService {
    constructor(afAuth, db) {
        this.afAuth = afAuth;
        this.db = db;
        this.uid = this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(state => {
            if (!state) {
                return null;
            }
            else {
        ...
        this.isAdmin = this.uid.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(uid => {
            if (!uid) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthService, [{
    ...
    }], function () { return [{ type: _angular_fire_auth__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuth"] }, { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_4__["AngularFireDatabase"] }]; }, null); })();


/***/ })

}]);
//# sourceMappingURL=default~modules-admin-admin-module~modules-login-login-module-es2015.js.map