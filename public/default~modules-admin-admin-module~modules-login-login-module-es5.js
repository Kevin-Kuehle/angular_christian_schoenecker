...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modules-admin-admin-module~modules-login-login-module"], {
  /***/
  ...
  function srcAppCoreServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthService = /*#__PURE__*/function () {
      function AuthService(afAuth, db) {
        ...
        this.afAuth = afAuth;
        this.db = db;
        this.uid = this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (state) {
          if (!state) {
            return null;
          } else {
            return state.uid;
        ...
        this.isAdmin = this.uid.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(function (uid) {
          if (!uid) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(false);
          } else {
            return _this2.db.object('admin/' + uid).valueChanges();
          }
        }));
      }
      ...
      _createClass(AuthService, [{
        key: "login",
        value: function login(email, passwort) {
          try {
            this.afAuth.signInWithEmailAndPassword(email, passwort);
          } catch (error) {
            console.log(" Error in loginFunction ".concat(error.message, " "));
          }
        }
      }, {
        key: "logout",
    ...
    AuthService.ɵfac = function AuthService_Factory(t) {
      return new (t || AuthService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_fire_auth__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuth"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_fire_database__WEBPACK_IMPORTED_MODULE_4__["AngularFireDatabase"]));
    };
...
//# sourceMappingURL=default~modules-admin-admin-module~modules-login-login-module-es5.js.map